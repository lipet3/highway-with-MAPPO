...
def get_config():
    ...
    # env parameters
    parser.add_argument("--env_name", type=str, default="HighwayEnv", help="specify the name of environment")
    parser.add_argument(
        "--use_obs_instead_of_state",
        action="store_true",
        default=True, # 直接将默认值改为 True
    ...
    parser.add_argument(
        "--share_policy",
        action="store_true",  # 改为 store_true
